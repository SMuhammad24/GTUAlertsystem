...
strict SIH template criteria with large, readable fonts and optimized space utilization.
"""
...
def create_sih_presentation():
    ...
    def add_sih_header_and_footer(slide, slide_title, slide_number, total_slides=10):
        ...
        tag_box = slide.shapes.add_textbox(Inches(8.2), Inches(0.18), Inches(4.5), Inches(0.85))
        ...
        # Slide Title
        t_box = slide.shapes.add_textbox(Inches(0.65), Inches(0.22), Inches(7.5), Inches(0.75))
        ...
        # Footer Text Left
        f_box_l = slide.shapes.add_textbox(Inches(0.65), Inches(7.12), Inches(8.5), Inches(0.35))
    ...
    def create_sih_card(slide, left, top, width, height, title, points, header_color=SIH_BLUE, badge_text=None, font_size=13, space_after=10):
        # Card Background
        ...
        header_height = Inches(0.68) if badge_text else Inches(0.58)
        ...
        # Header Title
        title_box = slide.shapes.add_textbox(left + Inches(0.2), top + Inches(0.06), width - Inches(0.4), header_height - Inches(0.08))
        ...
        # Content Box - utilizing vertical space nicely
        content_top = top + header_height + Inches(0.12)
        content_height = height - header_height - Inches(0.2)
    ...
    # SIH Event Tag
    sih_tag = s1.shapes.add_textbox(Inches(0.65), Inches(0.25), Inches(12.0), Inches(0.4))
    ...
    # 4 Cards spanning full horizontal width with minimal gaps
    c_w = Inches(2.82)
    c_gap = Inches(0.24)
    c_top = Inches(2.35)
    c_h = Inches(4.6)

    create_sih_card(s1, Inches(0.65) + (c_w + c_gap) * 0, c_top, c_w, c_h, "Problem Statement", [
        "Problem ID: SIH-EDU-042",
        "Category: Software Edition",
        "Theme: Smart Education & Campus Automation",
        "Domain: University Administration & Student Welfare",
        "Target Audience: 4,00,000+ GTU Students across 400+ Colleges"
    ], SIH_BLUE, font_size=12, space_after=9)

    create_sih_card(s1, Inches(0.65) + (c_w + c_gap) * 1, c_top, c_w, c_h, "The Innovation", [
        ...
        "AI Summarizer delivers 1-sentence instant takeaways."
    ], SIH_NAVY, font_size=12, space_after=9)

    create_sih_card(s1, Inches(0.65) + (c_w + c_gap) * 2, c_top, c_w, c_h, "Technology Stack", [
    ...
    ], SIH_GREEN, font_size=12, space_after=9)

    create_sih_card(s1, Inches(0.65) + (c_w + c_gap) * 3, c_top, c_w, c_h, "Team & Institute", [
        "Team Name: GTU Innovators",
        "Team Leader: [Your Name]",
        "Members: [Team Member Names]",
        "Department: Computer / IT Engineering",
        "Institute: [Your College Name]",
        "Faculty Mentor: [Guide / HOD Name]"
    ], SIH_ORANGE, font_size=12, space_after=9)
    ...
    create_sih_card(s2, Inches(0.65) + (col3_w + col3_gap) * 0, c_top2, col3_w, c_h2, "1. Severe Penalty Fees", [
        ...
        "Students from remote areas lack immediate campus access."
    ], SIH_RED, "FINANCIAL & ACADEMIC LOSS", font_size=13, space_after=11)

    create_sih_card(s2, Inches(0.65) + (col3_w + col3_gap) * 1, c_top2, col3_w, c_h2, "2. High Faculty & CR Burden", [
    ...
    ], SIH_ORANGE, "MANUAL ADMINISTRATIVE OVERHEAD", font_size=13, space_after=11)

    create_sih_card(s2, Inches(0.65) + (col3_w + col3_gap) * 2, c_top2, col3_w, c_h2, "3. Portal Traffic & Noise", [
    ...
    ], SIH_BLUE, "TECHNICAL FRICTION & UNINDEXED CHAOS", font_size=13, space_after=11)
    ...
    c_top3_r1 = Inches(1.35)
    c_top3_r2 = Inches(4.18)
    c_h3 = Inches(2.75)

    create_sih_card(s3, Inches(0.65), c_top3_r1, col2_w, c_h3, "1. Real-Time Push Notification Engine", [
    ...
    ], SIH_BLUE, font_size=13.5, space_after=10)

    create_sih_card(s3, Inches(0.65) + col2_w + col2_gap, c_top3_r1, col2_w, c_h3, "2. Intelligent NLP Tagging & Extraction", [
    ...
    ], SIH_NAVY, font_size=13.5, space_after=10)

    create_sih_card(s3, Inches(0.65), c_top3_r2, col2_w, c_h3, "3. AI Summarizer & Gujarati Localization", [
        "Google Gemini AI summarizes complex 10-page circulars into 2 clear sentences.",
    ...
    ], SIH_GREEN, font_size=13.5, space_after=10)

    create_sih_card(s3, Inches(0.65) + col2_w + col2_gap, c_top3_r2, col2_w, c_h3, "4. Multi-Channel Accessibility & Voice News", [
    ...
    ], SIH_ORANGE, font_size=13.5, space_after=10)
    ...
    create_sih_card(s4, Inches(0.65) + (f_w + f_gap) * 0, f_top, f_w, f_h, "Phase 1: Ingestion", [
    ...
    ], SIH_BLUE, "DATA HARVESTING", font_size=12.5, space_after=11)

    create_sih_card(s4, Inches(0.65) + (f_w + f_gap) * 1, f_top, f_w, f_h, "Phase 2: Storage & Dedupe", [
    ...
    ], SIH_NAVY, "DATA PERSISTENCE", font_size=12.5, space_after=11)

    create_sih_card(s4, Inches(0.65) + (f_w + f_gap) * 2, f_top, f_w, f_h, "Phase 3: Intelligence", [
    ...
    ], SIH_ORANGE, "AI & NLP LAYER", font_size=12.5, space_after=11)

    create_sih_card(s4, Inches(0.65) + (f_w + f_gap) * 3, f_top, f_w, f_h, "Phase 4: Multi-Dispatch", [
    ...
    ], SIH_GREEN, "DELIVERY CHANNELS", font_size=12.5, space_after=11)
    ...
    create_sih_card(s5, Inches(0.65), Inches(1.35), Inches(5.88), Inches(5.6), "Comprehensive Technology Stack", [
    ...
    ], SIH_NAVY, "STACK OVERVIEW", font_size=13, space_after=9)

    create_sih_card(s5, Inches(0.65) + Inches(5.88) + Inches(0.24), Inches(1.35), Inches(5.88), Inches(5.6), "What Makes Our Solution Different?", [
    ...
    ], SIH_GREEN, "COMPETITIVE EDGE", font_size=13, space_after=9)
    ...
    create_sih_card(s6, Inches(0.65), Inches(1.35), Inches(5.88), Inches(5.6), "What We DO NOT Do (Zero Risk Guarantee)", [
    ...
    ], SIH_RED, "STRICT NON-INTRUSION POLICY", font_size=13, space_after=10)

    create_sih_card(s6, Inches(0.65) + Inches(5.88) + Inches(0.24), Inches(1.35), Inches(5.88), Inches(5.6), "What We DO (Ethical & Legal Compliance)", [
    ...
    ], SIH_GREEN, "COMPLIANCE ASSURANCE", font_size=13, space_after=10)
    ...
    create_sih_card(s7, Inches(0.65) + (col3_w + col3_gap) * 0, c_top2, col3_w, c_h2, "1. Technical Feasibility", [
    ...
    ], SIH_BLUE, "PROVEN RELIABILITY", font_size=13, space_after=11)

    create_sih_card(s7, Inches(0.65) + (col3_w + col3_gap) * 1, c_top2, col3_w, c_h2, "2. Extreme Scalability", [
    ...
    ], SIH_NAVY, "INFINITE STUDENT CAPACITY", font_size=13, space_after=11)

    create_sih_card(s7, Inches(0.65) + (col3_w + col3_gap) * 2, c_top2, col3_w, c_h2, "3. ₹0 Cloud Cost Model", [
    ...
    ], SIH_GREEN, "100% FREE OPERATION", font_size=13, space_after=11)
    ...
    create_sih_card(s8, Inches(0.65) + (col3_w + col3_gap) * 0, c_top2, col3_w, c_h2, "Impact on Students", [
    ...
    ], SIH_GREEN, "STUDENT WELFARE", font_size=13, space_after=11)

    create_sih_card(s8, Inches(0.65) + (col3_w + col3_gap) * 1, c_top2, col3_w, c_h2, "Impact on Faculty & Colleges", [
    ...
    ], SIH_BLUE, "ADMINISTRATIVE PRODUCTIVITY", font_size=13, space_after=11)

    create_sih_card(s8, Inches(0.65) + (col3_w + col3_gap) * 2, c_top2, col3_w, c_h2, "National Mission Alignment", [
    ...
    ], SIH_ORANGE, "NATIONAL IMPACT", font_size=13, space_after=11)
    ...
    create_sih_card(s9, Inches(0.65), Inches(1.35), Inches(5.88), Inches(5.6), "1. Interactive Live Telegram Bot Demo", [
    ...
    ], SIH_BLUE, "BOT DEMONSTRATION", font_size=13, space_after=11)

    create_sih_card(s9, Inches(0.65) + Inches(5.88) + Inches(0.24), Inches(1.35), Inches(5.88), Inches(5.6), "2. Web Dashboard & PWA Capabilities", [
    ...
    ], SIH_GREEN, "PWA & REPOSITORY DEMO", font_size=13, space_after=11)
    ...
    create_sih_card(s10, Inches(0.65), Inches(1.35), Inches(5.88), Inches(3.4), "Future Roadmap (Post-Hackathon)", [
    ...
    ], SIH_NAVY, "PROJECT ROADMAP", font_size=13, space_after=9)

    create_sih_card(s10, Inches(0.65) + Inches(5.88) + Inches(0.24), Inches(1.35), Inches(5.88), Inches(3.4), "Summary & Core Value", [
    ...
    ], SIH_GREEN, "EXECUTIVE SUMMARY", font_size=13, space_after=9)
